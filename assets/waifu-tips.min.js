window.live2d_settings = Array(); /*
    ...
    　　　　 !,/7 '0'　　 ´0iソ| 　 |　　　
    　　　　 |.从"　　_　　 ,,,, / |./ 　 |             网页添加 Live2D 看板娘
    　　　　 ﾚ'| i＞.､,,__　_,.イ / 　.i 　|                    https://nicky-chin.cn
    　　　　　 ﾚ'| | / k_７_/ﾚ'ヽ,　ﾊ.　|           
    　　　　　　 | |/i 〈|/　 i　,.ﾍ |　i　|    Thanks
...
// 后端接口
live2d_settings['modelAPI']             = '//www.nicky-chin.cn/api/';   // 自建 API 修改这里
...
live2d_settings['aboutPageUrl']         = 'https://www.nicky-chin.cn/';   // 关于页地址, '{URL 网址}'
...
function initModel(waifuPath, type) {
    ...
    $('.waifu-tool .fui-home').click(function (){
        //window.location = 'https://nicky-chin.cn/';
